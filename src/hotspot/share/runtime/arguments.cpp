...
jint Arguments::parse(const JavaVMInitArgs* initial_cmd_args) {
  ...
  if (TraceFPUStack) LogConfiguration::configure_stdout(LogLevel::Trace, false, LOG_TAGS(fpustack));
  if (TracePatching) LogConfiguration::configure_stdout(LogLevel::Trace, false, LOG_TAGS(patching));
  ...
  if (TraceDerivedPointers) LogConfiguration::configure_stdout(LogLevel::Trace, false, LOG_TAGS(derivedpointers));
  ...
  if (PrintInitialBlockList) LogConfiguration::configure_stdout(LogLevel::Trace, false, LOG_TAGS(initialblocklist));
    ...
    if (PrintEscapeAnalysis) LogConfiguration::configure_stdout(LogLevel::Trace, false, LOG_TAGS(escapeanalysis));
  #endif
  #ifndef PRODUCT
    ...
    if (PrintOptimizeStringConcat) LogConfiguration::configure_stdout(LogLevel::Trace, false, LOG_TAGS(optimizestringconcat));
